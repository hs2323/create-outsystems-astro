...
- Updated dependency eslint-plugin-vue to 10.9.0.
...
- Updated dependency astro to 6.2.2.
...
- Updated dependency @oxc-project/runtime to 0.128.0.
...
- Updated dependency @angular/cli to  21.2.9.
- Updated dependency @angular/build to 21.2.9.
- Updated dependency @angular/animations to 21.2.11.
- Updated dependency @angular-devkit/schematics to 21.2.9.
- Updated dependency @angular-devkit/architect to 0.2102.9.
