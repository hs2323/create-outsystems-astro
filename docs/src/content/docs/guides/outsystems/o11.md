...
![Create an application in OutSystems 11](../../../../assets/create-application.png)

- On the **How do you want to start screen?**, select the **From scratch** option. Click on the **Next** button.
![Select From scratch app option](../../../../assets/create-application-from-scratch.png)

- On the  **What you are building screen?**, select the **Reactive Web App** option. Click on the **Next** button.
![Select Reactive Web App option ](../../../../assets/create-application-reactive-app.png)
...
![Fill in application basic info](../../../../assets/create-application-basic-info.png)
...
![Select Astro Library dependency](../../../../assets/add-dependency-components.png)
...
- (Optional) Give the module a description and icon.
    ...
    ![Editing module description](../../../../assets/module-description.png)
    - In the information panel, click on the dropdown that says **Defaul Icon** and select **Change Icon**.
    ![Editing the default module icon](../../../../assets/module-icon.png)
...
![Add module UI Flow](../../../../assets/module-add-ui-flow.png)
![Set module UI Flow name](../../../../assets/module-add-ui-flow-name.png)

- Right click on the newly created flow and click Add Block. Give it a name.
![Add new block](../../../../assets/module-add-block.png)
![Set block name](../../../../assets/module-add-block-name.png)
...
- Give the block a description and icon.  It is recommended to add description and change the default icon. If both of these are done, when consumed, your library/widget can be made available as a selectable element in the component panel. 
    ...
    ![Editing the block description](../../../../assets/block-add-description.png)
    - In the information panel, click on the dropdown that says **Defaul Icon** and select **Change Icon**.
    ![Editing the default module icon](../../../../assets/block-icon.png)

- Change the Public attribute to Yes if this block will be consumed by other modules.
![Changing the public attribute of the block](../../../../assets/block-public.png)
...
![Add input parameter](../../../../assets/block-add-input-parameter.png)
![Modify input parameter name and type](../../../../assets/block-input-parameter-name-type.png)

- Go to the Data tab in Service Studio.
![Select Data tab](../../../../assets/block-prop-data-tab.png)

- Right click on structures and select ```Add a structure```.
![Add structure](../../../../assets/props-add-structure.png)
...
![Set structure name](../../../../assets/props-structure-name.png)
...
![Add structure attributes](../../../../assets/props-add-structure-attributes.png)

- Go back to the Interface tab and click on the block.
![Select Interface tab](../../../../assets/select-interface-tab.png)

- Right click on the block and select **Add a local variable**.
![Add local variable](../../../../assets/params-add-local-variable.png)
...
![Set local variable name and type](../../../../assets/params-set-name-type.png)
...
![SerializedProps local variable](../../../../assets/props-serialized.png)
...
- If there are any functions handlers coming in, create a function and a function handler. The function should call the handler (with any parameters that it needs).
    ...
    ![Add Client Action](../../../../assets/add-client-action.png)
    ...
    ![Add Event](../../../../assets/add-event-handler.png)
    - You can then assign the event handler inside of the client actions. 
    ![Add event handler to client action](../../../../assets/add-event-handler-client-action.png)

- Right click on the Counter block and select Add Client Action. Name it PrepareProps.
![Add Client Action PrepareProps](../../../../assets/add-prepare-props.png)
...
![Add JavaScript SetFunctionProps](../../../../assets/add-javascript-set-function-props.png)
![Add JavaScript content for SetFunctionProps](../../../../assets/add-javascript-set-function-props-content.png)
...
- Inside of the JavaScript block, you will need to bind any function handlers to the document body. There is also and Astro Island function to randomize the name so that there are no function collisions. You can use the following script to bind them (update names to match your components):
    ...
    ```
    ![Set the function props content](../../../../assets/set-function-props-content.png)

- Right click on parameters and select ```Add Output Parameter```.
![Set function props output parameter](../../../../assets/set-function-props-add-output-parameter.png)
...
![Set function props output name and type](../../../../assets/set-function-props-output-name-type.png)
...
![Assign local variable Props. ](../../../../assets/prepare-props-assign.png)

- Add the **JSON Serialize** element to the flow.
![Add JSON Serialize to PrepareProps](../../../../assets/prepare-props-json-serialize.png)

- Set the **Props** variable as the **Data** value.
![Set Props variable for JSON Serialize](../../../../assets/prepare-props-json-serialize-data.png)
...
![Add assign block](../../../../assets/prepare-props-assign-serialized.png)
![Set output of JSON Serialized to param](../../../../assets/props-serialized-assign.png)

#### Initialize parameters
- Go to the library component and scroll down in the properties to create an OnInitialize handler.
![Add OnInitialize handler](../../../../assets/on-initialize-handler.png)

- Do the same thing for the OnParametersChange handler.
![Add OnParametersChanged handler](../../../../assets/on-parameters-changed-handler.png)

- Go back to the OnInitialize client action and drag over the created PrepareProps action.
![Add PrepareProps to OnInitalize hander](../../../../assets/on-initialize-prepare-props.png)

- Double click the OnParametersChanged and drag over PrepareProps.
![Add PrepareProps to OnParametersChanged hander](../../../../assets/on-parameters-changed-prepare-props.png)
...
![Import JavaScript resources](../../../../assets/import-resource.png)

- Set the Public property to **Yes** and the Deploy Action to **Deploy to Target Directory**.
![Set the JavaScript property and Deploy Action](../../../../assets/js-resource-properties.png)
...
![Add an image resource](../../../../assets/import-image-resource.png)
...
![Import Astro Island component](../../../../assets/import-astroisland.png)
...
![Parameter set Island Component URL](../../../../assets/island-component-url.png)
...
![Select Island Component URL value](../../../../assets/island-component-url.png)

- Click on the **RendererURL** dropdown and select **Expression Editor**.
![Parameter set Island Component URL](../../../../assets/island-renderer-url.png)
...
![Select Island Renderer URL value](../../../../assets/island-renderer-url-value.png)

- Click on the **Props** dropdown and select ```PropsSerialized```.
![Select Island Props value](../../../../assets/island-props.png)

- Click on the **Opts** dropdown and select **Expression Editor**.
![arameter set Island Opts](../../../../assets/islands-opts.png)

- Enter the value from the ```astro-island``` ```opts``` parameter into the window and click the red **Close** button.
![Select Island Opts value](../../../../assets/islands-opts-value.png)
...
![Select stylesheet for the block](../../../../assets/styles-select-stylesheets.png)

- Enter any styles that are in an output ```.CSS``` stylesheet file.
![Add the CSS styles to the block](../../../../assets/styles-add-stylesheet.png)
...
![Select the Widget Tree tab](../../../../assets/visual-select-widget-tree.png)

- Right click on the elements and click **Enclose in If**.
![Select Enclose in If](../../../../assets/set-function-props-output-name-type.png)
...
![Set If false branch](../../../../assets/visual-false-branch.png)
...
![Visual layout of component](../../../../assets/visual-layout.png)
...
![Visual representation add images](../../../../assets/visual-images.png)
